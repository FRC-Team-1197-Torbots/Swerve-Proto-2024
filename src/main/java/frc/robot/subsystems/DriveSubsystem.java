...
public class DriveSubsystem extends SubsystemBase {
  ...
  private SlewRateLimiter m_magLimiter = new SlewRateLimiter(DriveConstants.kMagnitudeSlewRate); // Controls how intense the acceleration on the joystick is and flattens it to drive smoother
